...
I also found out that on line 145 of [awful/glues_it_CLEANED.php](http://git.io/vs46w) that there is a possible/interesting point, take a look at:
```sh
...
backwards (that is why at line 20 of [glues_it_CLEANED.php](http://git.io/vs46w) "strrev" is used, to reverse the string) we get
```sh
